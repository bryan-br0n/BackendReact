...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-IQPGHAA\\SQLEXPRESS;Initial Catalog=registroAlumno;User ID=Josue_User;Password=12345;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FBE72C1EE");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83F749FDD64");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F3B63BE8A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F6D094D3B");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7A4B375CE");
